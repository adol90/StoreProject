...
class MySectionsVC : UIViewController {
...
extension MySectionsVC : UITableViewDelegate , UITableViewDataSource {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let destinationVC = segue.destination as? AddNewSectionVC {
            destinationVC.editedSetction = selectedSection
        }
    }
}
